package com.kaua.events.platform.domain.validation.handler;
...
import com.kaua.events.platform.domain.validation.Validator;
...
class NotificationHandlerTest extends UnitTest {
    ...
    void givenAValidValidation_whenCallValidate_thenShouldThrowsException() {
        final var expectedErrorMessage = "Cannot invoke \"com.kaua.events.platform.domain.validation.ValidationHandler$Validation.validate()\" because \"aValidation\" is null";
        NotificationHandler handler = NotificationHandler.create();
